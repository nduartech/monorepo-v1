  ...
  return (
    <div class="w-full h-full flex flex-col md:flex-row"
     ...
     onMouseOut={()=>{
      ...
      <div class="flex flex-col justify-center items-center h-3/6 min-h-fit w-full md:h-full md:w-4/12 lg:w-3/12 bg-gray-800">
      ...
      <div
        class="flex flex-col justify-start items-center h-4/6 min-h-fit w-full md:h-full md:w-8/12 lg:w-9/12 bg-gray-900 pt-5 min-h-fit">
        <Show when={page() === 0}>
